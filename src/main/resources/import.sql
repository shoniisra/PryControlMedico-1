...
INSERT INTO MEDICO (IDPERSONA, APELLIDOS, CEDULA, EMAIL, NOMBRES, TELEFONO, ESPECIALIDAD, LICENCIA) VALUES (1,'Ordóñez Fernández', '0502478112', 'santiago@iess.org', 'Santiago Felipe', '0997845112', 'Endocrinología', '4215')
INSERT INTO MEDICO (IDPERSONA, APELLIDOS, CEDULA, EMAIL, NOMBRES, TELEFONO, ESPECIALIDAD, LICENCIA) VALUES (2,'Torres Vélez', '0506489511', 'alejandra@iess.org', 'Alejandra Susana', '09964887415', 'Traumatología', '7845')
...
INSERT INTO RECETA(IDRECETA,FECHA,ACTIVO,IDMEDICO,IDPACIENTE)VALUES(1,'1970-04-14',TRUE,1,1)
INSERT INTO RECETA(IDRECETA,FECHA,ACTIVO,IDMEDICO,IDPACIENTE)VALUES(2,'1975-04-14',TRUE,2,2)

  INSERT INTO MEDICAMENTO (IDMEDICAMENTO, COMPONENTEACTIVO, CONCENTRACION, NOMBRECOMERCIAL, PRECIO, FECHACADUCIDAD, IDVIAADMINISTRACION) VALUES (1,'Parecetamol - Pseudoefedrina Clorhidrato - Clorfenamina Maleato', '100 ml', 'TrioVal', 3.50, '2000-01-1', 1)
  INSERT INTO MEDICAMENTO (IDMEDICAMENTO, COMPONENTEACTIVO, CONCENTRACION, NOMBRECOMERCIAL, PRECIO, FECHACADUCIDAD, IDVIAADMINISTRACION) VALUES (2,'Ibuprofeno', '120 ml', 'Buprex Forte', 5.50, '2000-01-1', 1)
  INSERT INTO MEDICAMENTO (IDMEDICAMENTO, COMPONENTEACTIVO, CONCENTRACION, NOMBRECOMERCIAL, PRECIO, FECHACADUCIDAD, IDVIAADMINISTRACION) VALUES (3,'', 'Q10', 'Immuvit Plus Q10', 15.00, '2000-01-1', 1)
  INSERT INTO MEDICAMENTO (IDMEDICAMENTO, COMPONENTEACTIVO, CONCENTRACION, NOMBRECOMERCIAL, PRECIO, FECHACADUCIDAD, IDVIAADMINISTRACION) VALUES (4,'Mometasona Furoato - Clorhidrato Azelastina', '50mcg + 140mcg', 'Momate AZ', 7.50, '2000-01-1', 10)
  ...
  INSERT INTO DOSIS(IDDOSIS,DESCRIPCION,ESTADO,FECHAHORA,NUMERO,IDDETALLERECETA) VALUES(7,'Miercoles',0,'1975-04-14',1,3)
  INSERT INTO DOSIS(IDDOSIS,DESCRIPCION,ESTADO,FECHAHORA,NUMERO,IDDETALLERECETA) VALUES(8,'Miercoles',0,'1975-04-14',1,3)
  INSERT INTO DOSIS(IDDOSIS,DESCRIPCION,ESTADO,FECHAHORA,NUMERO,IDDETALLERECETA) VALUES(9,'Miercoles',0,'1975-04-14',1,4)
  INSERT INTO DOSIS(IDDOSIS,DESCRIPCION,ESTADO,FECHAHORA,NUMERO,IDDETALLERECETA) VALUES(10,'Miercoles',0,'1975-04-14',1,4)